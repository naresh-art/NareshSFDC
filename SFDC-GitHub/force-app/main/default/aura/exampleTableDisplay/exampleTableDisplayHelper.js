({
  ...
  //  {label: 'FirstName', fieldName: 'FirstName', type: 'text'},
	...
	//var retValue = component.get('v.OpportunityID');	 // Considering retValue contains Oppty Id		
    var row = event.getParam('row');
        var recordId = row.Id;
       
        var cancelRecordEvent = $A.get("e.force:navigateToSObject");
	cancelRecordEvent.setParams({
	  "recordId": recordId
	});
	cancelRecordEvent.fire();
},
})