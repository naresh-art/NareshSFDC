...
import Employee_Status from '@salesforce/schema/Employee__c.Status';

export default class PathShowComp extends LightningElement {
 @api recordId;   
 @api objectApiName;
 @wire(getPicklistValues, { recordTypeId: this.recordId, fieldApiName: Employee_Status })
...
import PICKLIST_FIELD from '@salesforce/schema/Lead.LeadSource';
...
export default class PathShowComp extends LightningElement {
    ...
    get picklistValues() {
        ...
        if (this.record.data) {
            if (!this.selectedValue && this.record.data.fields.LeadSource.value) {
                this.selectedValue = this.record.data.fields.LeadSource.value + '';
            }
    ...
    handleMarkAsSelected() {
        ...
        fields.LeadSource = this.selectedValue;
