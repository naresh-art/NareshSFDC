...
import saveSign from '@salesforce/apex/consentSignatureCtrl.saveSign';
...
export default class ConsentSignatureCmp extends LightningElement {
    @api recordId;
    ...
    */
    ...
    drawDot(){
        ...
        ctx.fillRect(currX, currY, y, y); //fill rectangle with coordinates
        ctx.closePath();
    }
}