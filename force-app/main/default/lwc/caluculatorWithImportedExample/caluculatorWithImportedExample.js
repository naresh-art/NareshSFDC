...
import {add2numbers,sub2numbers,fnum,snum} from 'c/caluculatorImportExporetExample';

export default class CaluculatorWithImportedExample extends LightningElement {
    firstNumber=fnum;
    secondNumber=snum;
    result;
    title=myfunction();
